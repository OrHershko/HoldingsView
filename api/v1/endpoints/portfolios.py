...
from api.crud import crud_holding, crud_portfolio
...
def create_holding(
    *,
    ...
    holding = crud_holding.create_with_portfolio(
        db=db, obj_in=holding_in, portfolio_id=portfolio_id
    )
    return holding
...
def update_holding(
    *,
    ...
    if not db_holding:
        raise HTTPException(
            status_code=404, detail="Holding not found in this portfolio"
        )
